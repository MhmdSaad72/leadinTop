...
<section class="py-5">
  ...
  <a class="btn btn-gradient-success " href="{{ route('products.create') }}">
          ...
          @foreach ($products as $key => $value)
            <tr>
              ...
              <td>{{ $value->created_at }}</td>
                <td>
                  <a class="btn btn-sm btn-success py-1 px-2 text-white" href="{{ route('products.edit', $value->id) }}"><i class="fas fa-edit text-xs"></i></a>
